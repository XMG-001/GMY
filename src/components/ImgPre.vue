                        ...
                        <el-skeleton style="width: 100%" :loading="loading" animated>
                            <template #template>
                                <el-skeleton-item variant="image"
                                    style="width: var(--el-upload-list-picture-card-size); height: var(--el-upload-list-picture-card-size)" />
                            </template>
                            <template #default>
...
// tabs 拖拽排序
const tabsDrop = () => {
    Sortable.create(document.querySelector(".el-upload-list--picture-card") as HTMLElement, {
...
async function generateFiles(n) {
    ...
    const url = ['https://api.yimian.xyz/img', 'https://www.dmoe.cc/random.php', 'https://api.r10086.com/%E6%A8%B1%E9%81%93%E9%9A%8F%E6%9C%BA%E5%9B%BE%E7%89%87api%E6%8E%A5%E5%8F%A3.php?%E5%9B%BE%E7%89%87%E7%B3%BB%E5%88%97=%E7%8E%8B%E8%80%85%E8%8D%A3%E8%80%80', 'https://api.r10086.com/%E6%A8%B1%E9%81%93%E9%9A%8F%E6%9C%BA%E5%9B%BE%E7%89%87api%E6%8E%A5%E5%8F%A3.php?%E5%9B%BE%E7%89%87%E7%B3%BB%E5%88%97=%E6%88%91%E7%9A%84%E4%B8%96%E7%95%8C%E7%B3%BB%E5%88%971'];

    for (let i = 0; i < n; i++) {
        const timestamp = new Date().toISOString().replace(/[-:.]/g, '').slice(0, 17); // 生成时间戳
